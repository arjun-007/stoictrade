...
namespace StoicTrade.Api.Controllers
{
    ...
    public class EngineController : ControllerBase
    {
        ...
        /// <summary>
        /// Returns recent signals generated by the strategy engine, newest-first.
        ...
        /// <summary>
        /// Clears the in-memory live signal queue.
        /// </summary>
        [HttpPost("signals/clear")]
        [Authorize]
        public IActionResult ClearSignals()
        {
            StrategyEngineService.ClearSignals();
            return Ok(new { Message = "Live signal log cleared successfully." });
        }
    }
