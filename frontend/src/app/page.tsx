...
function PendingApprovalsSection() {
  ...
  return (
    <div className="bg-orange-50 dark:bg-orange-900/20 border border-orange-200 dark:border-orange-800 p-6 rounded-2xl shadow-sm">
          ...
          <div key={app.id} className="bg-white dark:bg-slate-800 p-4 rounded-xl border border-orange-100 dark:border-orange-900 flex flex-col md:flex-row md:items-center justify-between gap-4">
            ...
            <div className="flex gap-2">
              <button 
                ...
                className="px-4 py-2 bg-slate-200 hover:bg-slate-300 dark:bg-slate-700 dark:hover:bg-slate-600 font-bold rounded-lg transition-colors"
              >
                DENY
              </button>
              <button 
                onClick={() => handleAction(app.id, 'approve')}
                className="px-6 py-2 bg-green-500 hover:bg-green-600 text-white font-bold rounded-lg transition-colors shadow-sm"
              >
                APPROVE
              </button>
            </div>
